...
- (void) setUpTheme {
    ...
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[theme navigationBarTitleTextAttributeForegroundColor]}];
    [[UIBarButtonItem appearance] setTintColor:[theme navigationBarTintColor]];
